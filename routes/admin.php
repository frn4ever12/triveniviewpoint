...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:orders.view')->group(function () {
        ...
        Route::get('/orders/{id}/bill', [OrderController::class, 'printBill'])
            ->name('orders.bill');
        Route::get('/orders/{id}/view-bill', [OrderController::class, 'viewBill'])
            ->name('orders.view-bill');
        Route::get('/orders/{id}/download-bill-pdf', [OrderController::class, 'downloadBillPdf'])
            ->name('orders.download-bill-pdf');
