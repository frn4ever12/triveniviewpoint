...
// Public test notification endpoint for QR menu (GET to avoid CSRF issues)
Route::get('/api/qr/test-notification', [QrOrderController::class, 'testNotification'])->name('qr.test.notification');
