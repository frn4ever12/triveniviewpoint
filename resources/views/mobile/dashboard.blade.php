...
<body>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value">{{ $activeTables ?? 0 }}</div>
    ...
    <div class="quick-actions">
        <div class="action-grid">
            <a href="{{ route('admin.orders.pos') }}" class="action-item">
                <div class="action-icon new-order">
                    <i class="bi bi-plus-lg"></i>
                </div>
                <div class="action-label">New Order</div>
            </a>
            <a href="{{ route('admin.menu-items.index') }}" class="action-item">
                <div class="action-icon menu">
                    <i class="bi bi-list-ul"></i>
                </div>
                <div class="action-label">Menu</div>
            </a>
            <a href="{{ route('admin.tables.index') }}" class="action-item">
            ...
            <a href="{{ route('admin.orders.index') }}" class="action-item">
                <div class="action-icon reports">
                    <i class="bi bi-bar-chart"></i>
                </div>
                <div class="action-label">Orders</div>
            </a>
            <a href="{{ route('admin.website.edit') }}" class="action-item">
    ...
    <div class="recent-orders">
        ...
        <div class="order-card">
            ...
            <div class="order-details">
                ...
                <span class="order-amount">Rs.{{ number_format($order->total_amount) }}</span>
            </div>
        </div>
        @endforeach
    ...
    <div class="bottom-nav">
        <a href="{{ route('mobile.dashboard') }}" class="nav-item active">
        ...
        <a href="{{ route('admin.orders.pos') }}" class="nav-item">
            <i class="bi bi-cart"></i>
            <span>POS</span>
        </a>
        <a href="{{ route('admin.menu-items.index') }}" class="nav-item">
            <i class="bi bi-grid"></i>
            <span>Menu</span>
        </a>
        <a href="{{ route('admin.tables.index') }}" class="nav-item">
