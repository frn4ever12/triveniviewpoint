            ...
            <div class="col-lg-6">
                <div class="hero-content">
                    ...
                    <div class="hero-buttons">
                        <a href="{{ route('register.restaurant') }}" class="btn btn-primary btn-lg">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="restaurant-card">
                        <div class="restaurant-card-header">
                            @if($tenant->logo)
                                <img src="{{ $tenant->getFirstMediaUrl('logo') }}" alt="{{ $tenant->name }}" class="restaurant-logo">
                            @else
                            ...
                            @if($tenant->subscription && $tenant->subscription->plan)
                                <span class="restaurant-badge">{{ $tenant->subscription->plan->name }}</span>
                            @endif
                        </div>
                        <div class="restaurant-card-body">
                            <h4 class="restaurant-name">{{ $tenant->name }}</h4>
                            @if($tenant->company_name)
                                <p class="restaurant-company">{{ $tenant->company_name }}</p>
                            @endif
                            <div class="restaurant-location">
                                <i class="bi bi-geo-alt"></i>
                                {{ $tenant->city ?? 'Nepal' }}, {{ $tenant->country ?? 'Nepal' }}
                            </div>
                            <div class="restaurant-actions">
                                <a href="{{ route('tenant.show', $tenant->slug) }}" class="btn btn-primary">
                                    <i class="bi bi-eye me-1"></i> View Menu
                                </a>
                                <a href="{{ route('digitalmenu', $tenant->slug) }}" class="btn btn-outline-primary">
        ...
        @else
            <div class="text-center py-5">
                <div class="empty-state">
                    ...
                    <a href="{{ route('register.restaurant') }}" class="btn btn-primary mt-3">
        ...
        <div class="cta-card">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 text-lg-end">
                    <a href="{{ route('register.restaurant') }}" class="btn btn-light btn-lg">
