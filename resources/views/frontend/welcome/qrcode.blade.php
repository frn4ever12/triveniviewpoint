            ...
            <div class="col-lg-10">
                <div class="digital-card" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <div class="d-flex gap-2 mt-4 justify-content-center">
                        ...
                        @if(isset($tenant))
                        <a href="{{ route('digitalmenu', $tenant->slug) }}" class="hero-btn-secondary d-inline-flex">
...
<script>
    ...
    new QRCode(document.getElementById("qrcode-menu"), {
        text: "{{ route('digitalmenu', $tenant->slug) }}",
        width: 180,
        height: 180
    });
    ...
    function generateTableQr() {
        ...
        const tableMenuUrl = `{{ route('digitalmenu-table', ['slug' => $tenant->slug]) }}/${tableId}`;
    ...
    function downloadTableQr(tableId) {
        ...
        if (qrCanvas) {
            ...
            link.download = `qr-menu-{{ $tenant->slug }}-${tableName.replace(/\s+/g, '-').toLowerCase()}.png`;
