...
@endpush
@section('content')
    <x-breadcrumb title="Subscription Plans" route="admin.subscription-plans.create" button="Add New Plan" icon="bi-plus-circle">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('admin.subscription-plans.show', $plan) }}" class="btn btn-sm btn-outline-primary flex-grow-1 me-1">
                                    <i class="bi bi-eye"></i> View
                                </a>
                                <a href="{{ route('admin.subscription-plans.edit', $plan) }}" class="btn btn-sm btn-outline-secondary flex-grow-1 me-1">
