...
@section('content')
    <x-breadcrumb title="Subscription Details" route="admin.subscriptions.index" button="Back to Subscriptions" icon="bi-arrow-left">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{ $subscription->tenant->name }}</li>
    </x-breadcrumb>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('admin.subscriptions.edit', $subscription) }}" class="btn btn-sm btn-primary">
