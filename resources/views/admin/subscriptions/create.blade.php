...
@section('content')
    <x-breadcrumb title="Create Subscription" route="admin.subscriptions.index" button="Back to Subscriptions" icon="bi-arrow-left">
        ...
        <li class="breadcrumb-item active" aria-current="page">Create Subscription</li>
    </x-breadcrumb>
