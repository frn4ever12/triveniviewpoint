...
@section('content')
    <x-breadcrumb title="Create Plan Feature" route="admin.plan-features.index" button="Back to Features" icon="bi-arrow-left" :route-params="['planId' => $plan->id]">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.plan-features.store', $plan->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
