...
@section('content')
    <div class="container-fluid">
        <div class="page-header mb-4">
            <h1 class="page-title">Edit Plan Feature</h1>
            <p class="page-subtitle">Update feature details for {{ $plan->name }}</p>
        </div>
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('superadmin.plan-features.update', $planFeature) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
