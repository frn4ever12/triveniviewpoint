...
@section('content')
    <div class="container-fluid">
        <div class="page-header mb-4">
            ...
            <p class="page-subtitle">View tenant information and subscription details</p>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('superadmin.tenants.edit', $tenant) }}" class="btn btn-sm btn-primary">
                        ...
                        @if($tenant->subscription)
                            ...
                            <div class="mt-3">
                                ...
                                @if($tenant->subscription->isActive())
                                    <form action="{{ route('superadmin.subscriptions.cancel', $tenant->subscription) }}" method="POST" class="d-inline">
                                        @csrf
