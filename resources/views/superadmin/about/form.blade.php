...
@section('content')
    ...
    <div class="container-fluid">
        <div class="page-header mb-4">
            ...
            <p class="page-subtitle">Manage homepage about section</p>
        </div>
        <div class="card">
            <div class="card-body">
                @if (isset($about))
                    <form action="{{ route('superadmin.abouts.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                    @else
                        <form action="{{ route('superadmin.abouts.store') }}" method="POST" enctype="multipart/form-data">
                @endif
                @csrf
