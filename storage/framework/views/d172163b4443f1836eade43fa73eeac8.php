    ...
    <div class="container-fluid px-3 px-lg-4 py-3">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <a href="<?php echo e(route('admin.orders.details')); ?>" class="btn btn-outline-danger btn-sm rounded-3">Order List</a>
                ...
                <a target="_blank" href="<?php echo e(route('admin.orders.pos')); ?>" class="btn btn-outline-danger btn-sm rounded-3">POS</a>
            </div>
        </div>
                ...
                <div class="card border-0 shadow-sm" style="border-radius:12px;">
                    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center py-3 px-3" style="border-radius:12px 12px 0 0;">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('admin.orders.pos')); ?>" class="btn btn-sm btn-danger rounded-3">
                                        ...
                                        <?php $__currentLoopData = $dishes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-6 col-lg-4 dish-card-wrap" data-menu-id="<?php echo e($dish->menu_id); ?>">
                                                <div class="dish-card-new">
                                                    <img src="<?php echo e($dish->image_url ?: 'https://via.placeholder.com/150x100?text=' . urlencode($dish->name)); ?>"
                                                    ...
                                                    <div class="dish-info-new">
                                                        ...
                                                        <button class="btn btn-outline-danger btn-sm w-100 rounded-3"
                                                                onclick="addToCart(<?php echo e($dish->id); ?>, '<?php echo e($dish->name); ?>', <?php echo e($dish->final_price ?? $dish->price); ?>, '<?php echo e($dish->image_url); ?>')">
