                ...
                <div class="pos-filters">
                    ...
                    <div class="pos-categories" id="menuCategorySlider">
                        ...
                        <?php $__currentLoopData = $menuCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button class="pos-cat-btn" data-category="<?php echo e($menuCategory->id); ?>"><?php echo e($menuCategory->name); ?></button>
                ...
                <div class="pos-items-container" id="menuItemsContainer">
                    <div id="menuItemsGrid">
                        ...
                        <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($dishesByMenu->has($menu->id) && $dishesByMenu[$menu->id]->count() > 0): ?>
                                <div class="pos-menu-section" data-category-id="<?php echo e($menu->menu_category_id); ?>">
                                    <div class="pos-menu-title">
                                        ...
                                        <span class="badge-count"><?php echo e($dishesByMenu[$menu->id]->count()); ?> items</span>
                                    </div>

                                    <div class="pos-items-grid">
                                        <?php $__currentLoopData = $dishesByMenu[$menu->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="pos-item-card"
                                                 data-menu-id="<?php echo e($dish->menu_id); ?>"
                                                ...
                                                <div class="pos-item-img-wrap">
                                                    <img src="<?php echo e($dish->image_url ?: asset('assets/images/defaultfood.png')); ?>" alt="<?php echo e($dish->name); ?>" class="pos-item-img">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <iframe src="<?php echo e(route('admin.orders.checkout-dashboard')); ?>" style="width:100%;height:600px;border:none;" onload="this.style.height = this.contentWindow.document.body.scrollHeight + 'px'"></iframe>
                </div>
                <div class="modal-footer">
                    <button type="button" class="pos-btn" style="background:var(--pos-surface);color:var(--pos-text);" data-bs-dismiss="modal">Close</button>
                </div>
