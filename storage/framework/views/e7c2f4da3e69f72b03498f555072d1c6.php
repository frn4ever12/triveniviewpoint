...
<head>
    ...
    <title>Kitchen Display - <?php echo e($siteName ?? 'RestaurantPro'); ?></title>

    <?php if($faviconUrl ?? false): ?>
...
<body>
    ...
    <header class="ktd-header">
        <h1><i class="bi bi-fire"></i> <?php echo e($siteName ?? 'RestaurantPro'); ?> <span class="ktd-badge">Kitchen Display</span></h1>
    ...
    <div class="ktd-grid" id="ktdGrid">
        <?php echo $__env->yieldContent('ktd-content'); ?>
    </div>

    <script src="<?php echo e(asset('assets/js/toaster.js')); ?>"></script>

    <?php if(session('success')): ?>
    <script>showToast('success', '<?php echo e(session('success')); ?>');</script>
    <?php endif; ?>
    <?php if(session('error')): ?>
    <script>showToast('error', '<?php echo e(session('error')); ?>');</script>
    <?php endif; ?>
...
</html><?php /**PATH D:\DMCRESTRO\singlerestro-main\resources\views/admin/ktd/layout.blade.php ENDPATH**/ ?>