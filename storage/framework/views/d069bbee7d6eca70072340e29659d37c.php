...
<body>
    <div class="login-container">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" id="loginForm">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="redirect_to" value="<?php echo e(route('mobile.dashboard')); ?>">
...
<?php /**PATH D:\DMCRESTRO\singlerestro-main\resources\views/auth/mobile-login.blade.php ENDPATH**/ ?>