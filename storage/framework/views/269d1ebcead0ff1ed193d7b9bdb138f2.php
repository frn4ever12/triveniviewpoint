    ...
    <div class="nav-scroller">
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <li class="nav-item">
                ...
                <div id="navOrders" class="collapse <?php echo e($isSubmenuActive(['admin.orders.*']) && !$isSubmenuActive(['admin.orders.pos']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.orders.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.orders.dine-in') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.dine-in')); ?>">
                                <i data-feather="users" class="icon-xs me-2"></i> Dine In Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.orders.takeaway') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.takeaway')); ?>">
                                <i data-feather="shopping-bag" class="icon-xs me-2"></i> Take Away Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.orders.delivery') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.delivery')); ?>">
                                <i data-feather="truck" class="icon-xs me-2"></i> Delivery Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.orders.online') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.online')); ?>">
                                <i data-feather="globe" class="icon-xs me-2"></i> Online Orders
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.orders.cancelled') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.cancelled')); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="navTables" class="collapse <?php echo e($isSubmenuActive(['admin.tables.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.digital-menu.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.digital-menu.index')); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="navKitchen" class="collapse <?php echo e($isSubmenuActive(['admin.kitchen-display.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="navMenu" class="collapse <?php echo e($isSubmenuActive(['admin.menu-items.*', 'admin.categories.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('admin.addons.index')); ?>">
                                <i data-feather="plus-circle" class="icon-xs me-2"></i> Add-ons / Extras
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.variations.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.variations.index')); ?>">
                                <i data-feather="sliders" class="icon-xs me-2"></i> Variations
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.modifiers.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.modifiers.index')); ?>">
                                <i data-feather="edit-2" class="icon-xs me-2"></i> Modifiers
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.combos.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.combos.index')); ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('admin.menu-availability.index') ? 'active' : ''); ?>" href="<?php echo e(route('admin.menu-availability.index')); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="navPurchases" class="collapse <?php echo e($isSubmenuActive(['admin.purchases.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="#">
            ...
            <li class="nav-item">
                ...
                <div id="navSuppliers" class="collapse <?php echo e($isSubmenuActive(['admin.suppliers.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="navExpenses" class="collapse <?php echo e($isSubmenuActive(['admin.expenses.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="#">
            ...
            <li class="nav-item">
                ...
                <div id="navStaff" class="collapse <?php echo e($isSubmenuActive(['admin.staff.*', 'admin.roles.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="#">
            ...
            <li class="nav-item">
                ...
                <div id="navSettings" class="collapse <?php echo e($isSubmenuActive(['admin.website.*']) ? 'show' : ''); ?>">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="#">
