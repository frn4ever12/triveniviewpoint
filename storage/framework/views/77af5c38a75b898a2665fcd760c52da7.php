    ...
    <nav class="navbar navbar-expand-lg">
        ...
        <div class="d-flex align-items-center">
            <div class="me-4 d-none d-md-block">
                <h5 class="mb-0 fw-bold text-primary"><?php echo e($currentTenant->name ?? 'Restaurant'); ?></h5>
            ...
            <div class="dropdown">
                <button class="btn btn-outline-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown">
                    ...
                    <?php echo e($currentTenant->name ?? 'Main Branch'); ?>
        ...
        <ul class="navbar-nav navbar-right-wrap ms-auto d-flex align-items-center">
            ...
            <li class="nav-item me-3 d-none d-lg-block">
                <div class="text-end">
                    <small class="d-block fw-bold text-danger"><?php echo e($bsDate ?? '2081-02-25'); ?> BS</small>
                    <small class="d-block text-muted"><?php echo e(\Carbon\Carbon::now()->format('Y-m-d')); ?> AD</small>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" data-bs-toggle="dropdown">
                    <?php if(Auth::user()->getFirstMediaUrl('profile_image')): ?>
                        <img alt="avatar" src="<?php echo e(Auth::user()->getFirstMediaUrl('profile_image', 'thumb')); ?>"
                            class="rounded-circle me-2" style="width: 32px; height: 32px;" />
                    <?php else: ?>
                        <div class="rounded-circle bg-primary d-flex align-items-center justify-content-center me-2" 
                            style="width: 32px; height: 32px;">
                            <span class="text-white fw-bold small"><?php echo e(substr(auth()->user()->name, 0, 2)); ?></span>
                        </div>
                    <?php endif; ?>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="px-4 pb-0 pt-2">
                        <h5 class="mb-1">Hello, <?php echo e(Auth::user()->name); ?></h5>
...
<?php /**PATH D:\DMCRESTRO\singlerestro-main\resources\views/admin/includes/header-new.blade.php ENDPATH**/ ?>