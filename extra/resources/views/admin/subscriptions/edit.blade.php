...
@section('content')
    <x-breadcrumb title="Edit Subscription" route="admin.subscriptions.index" button="Back to Subscriptions" icon="bi-arrow-left">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        @if($subscription->isActive())
                            <form action="{{ route('admin.subscriptions.cancel', $subscription) }}" method="POST" class="d-inline mb-2">
                                @csrf
                        ...
                        @if($subscription->isExpired() || $subscription->isCancelled())
                            <form action="{{ route('admin.subscriptions.renew', $subscription) }}" method="POST" class="d-inline mb-2">
                                @csrf
                        ...
                        @endif
                        <a href="{{ route('admin.tenants.show', $subscription->tenant) }}" class="btn btn-sm btn-outline-primary w-100">
