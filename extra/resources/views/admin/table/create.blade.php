...
@section('content')
    <div class="container-fluid">
        <x-breadcrumb title="Create New Table" route="admin.tables.index" button="Back to List" icon="bi-arrow-left" />
                ...
                <form action="{{ route('admin.tables.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                   id="name" name="name" value="{{ old('name') }}" placeholder="Name / Number" required>
                        ...
                        <div class="col-md-4 col-sm-12">
                            ...
                            <select class="form-select @error('table_type') is-invalid @enderror" id="table_type" name="table_type">
                                <option value="regular" {{ old('table_type') == 'regular' ? 'selected' : '' }}>Regular</option>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="has_air_conditioning" name="has_air_conditioning" value="1" {{ old('has_air_conditioning') ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_smoking_allowed" name="is_smoking_allowed" value="1" {{ old('is_smoking_allowed') ? 'checked' : '' }}>
                                <label class="form-check-label" for="is_smoking_allowed">Smoking Allowed</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_wheelchair_accessible" name="is_wheelchair_accessible" value="1" {{ old('is_wheelchair_accessible') ? 'checked' : '' }}>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save me-2"></i> Create Table
                        </button>
