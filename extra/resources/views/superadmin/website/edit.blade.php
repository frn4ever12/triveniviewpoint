...
<div class="container-fluid">
    <div class="page-header mb-4">
        ...
        <p class="page-subtitle">Manage website configuration and preferences</p>
    </div>
        ...
        <div class="tab-pane fade show active" id="identity" role="tabpanel">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('superadmin.website.identity.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <div class="col-md-6">
        ...
        <div class="tab-pane fade" id="contact" role="tabpanel">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('superadmin.website.contact.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <div class="col-md-6">
        ...
        <div class="tab-pane fade" id="social" role="tabpanel">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('superadmin.website.social.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <div class="col-md-6">
        ...
        <div class="tab-pane fade" id="seo" role="tabpanel">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('superadmin.website.seo.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
