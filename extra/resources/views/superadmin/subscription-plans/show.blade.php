...
@section('content')
    <div class="container-fluid">
        <div class="page-header mb-4">
            ...
            <p class="page-subtitle">View plan information and features</p>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="card @if($subscriptionPlan->is_popular) border-primary @endif">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('superadmin.subscription-plans.edit', $subscriptionPlan) }}" class="btn btn-sm btn-primary w-100">
            ...
            <div class="col-md-8">
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('superadmin.plan-features.create', $subscriptionPlan->id) }}" class="btn btn-sm btn-outline-primary">
                            ...
                            <table class="table table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('superadmin.plan-features.edit', $feature) }}" class="btn btn-sm btn-outline-secondary">
